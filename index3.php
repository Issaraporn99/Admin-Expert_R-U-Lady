 ...
 <?php 
    ...
    <form>
        <div class="row">
                <div class="col-md-5 ml-2">
                  ...
                  <!-- <a href="addDis.php" class="btn bg-maroon btn-flat">เพิ่มโรคใหม่</a>                               -->
                </div>
        </div>
    ...
    <form  action="symptom.php" method="POST" enctype="multipart/form-data">
           ...
           <!-- ตารางแสดงอาการของโรค   -->
              <div class="box-body">  
           <div class="box">
         <div class="tc"><h4>ตารางแสดงอาการของโรค</h4></div>         
                ...
                <tr>
                    <td><?php echo $i+1 ?></td>
                    <td><?php echo $key ?></td>
                    <td class="wid20"><a href="index3.php?deleteDis=<?php echo $i ?>"
