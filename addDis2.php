...
<div class="content-wrapper">
  ...
  <?php endif ?> -->
    <div class="box-header with-border">
      ...
      <a href="editSymDis.php?edit=<?php echo $disease_id; ?>" class="">แก้ไขอาการ<i class="fa fa-fw fa-edit"></i></a>
    ...
    <section class="box-body">
      ...
      <form action="disease.php" method="POST">
        ...
        <div class="form-group col-md-6 ">
          ...
          <textarea id="aa" class="form-control" cols="20" rows="4" placeholder="รายละเอียด ..." name="disease_detail"><?php echo $disease_detail; ?></textarea>
        </div>
        <div class="form-group col-md-6 ">
          <label>สาเหตุของการเกิดโรค</label>
          <textarea id="editor7" class="form-control" cols="20" rows="4" placeholder="สาเหตุของการเกิดโรค ..." name="disease_cause"><?php echo $disease_cause; ?></textarea>
        </div>
        <div class="form-group col-md-6">
          <label>การป้องกัน</label>
          <textarea id="editor8" class="form-control" rows="4" placeholder="การป้องกัน ..." name="disease_defence"><?php echo $disease_defence; ?></textarea>
        </div>
        <div class="form-group col-md-6">
          <label>การรักษา</label>
          <textarea id="editor9" class="form-control" rows="4" placeholder="การรักษา ..." name="disease_treatment"><?php echo $disease_treatment; ?></textarea>
        </div>
