              ...
              while ($row = $result->fetch_assoc()) : $date = date_create($row['issue_date']); ?>
                <tr>
                  ...
                  <td>
                    ...
                    <a href="articles.php?edit=<?php echo $row['articles_id']; ?>" class="btn btn-warning "><i class='fa fa-fw fa-edit'></i></a>
                    <a href="articlesAPI.php?delete=<?php echo $row['articles_id']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></a>
